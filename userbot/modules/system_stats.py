...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"┣ ✥ `Uptime   : `{uptime} \n"
        f"┗━━━━━━━━━━━━━━━━ \n"
        f"⚡️ **Repo Userbot :** [Syndicate-Userbot](https://github.com/syndicate28/Syndicate-Userbot) \n"
        f"⚡️ **Grup MainChat :** [Tekan Disini](https://t.me/SukinMass) \n"
...
async def amireallyalive(alive):
    ...
    uptime = await get_readable_time((time.time() - StartTime))
    output = (
        f"**[Syndicate-Userbot](https://github.com/syndicate28/Syndicate-Userbot) is Up and Running.**\n\n"
        ...
        " **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/SukinMass)** | **[𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺](https://instagram.com/pockybear28)** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/suppmusicquotes)** | **[𝗢𝘄𝗻𝗲𝗿](t.me/suppnigga)** "
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
